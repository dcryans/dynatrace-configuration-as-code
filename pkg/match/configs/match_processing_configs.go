...
func runRules(configProcessingPtr *match.MatchProcessing, matchParameters match.MatchParameters) MatchOutputType {
	...
	outputPayload := genOutputPayload(configProcessingPtr, remainingResultsPtr, matchedConfigs)
